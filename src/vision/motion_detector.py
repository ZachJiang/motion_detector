...
class Motion:
    ...
    def imageCallback1(self,image):
        ...
        h,(Rotation, Translation), frame, im_perspCorr, mid_dst=self.motion_detector1.detect_new(clean_image,side_view=3)        
    ...
    def imageCallback1_old(self,image):
        #broadcast the position of paper
    ...
    def imageCallback3(self,image):
        ...
        pt2 = copy.deepcopy(self.motion_detector1.pts_src[2])
