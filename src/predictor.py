...
class Motion_predictor:
    def __init__(self):
        ...
        self.motion_detector1.get_facets_info(result_img1,int(step-1))
    ...
    def imageCallback1(self,image):
        ...
        _,(Rotation, Translation), _, _, _=self.motion_detector2.detect_new(clean_image,side_view=3)        
        clean_image0 = copy.deepcopy(cv_image)
        # tvecs=self.motion_detector2.detect_pnp(clean_image0,3)
    ...
    def imageCallback2(self,image):
        ...
        is_blue=self.motion_detector2.detect_blue(clean_image0) #if there is blue color, return 1
        ...
        # print 'pt1',pt1
        # print 'pt2',pt2
        mid_point,result_img, image2 = self.motion_detector2.detect_mid_point(clean_image,pt1,pt2)
